...
@Entity
@Table(name = "avaliacao_trl_propriedade_intelectual")
@Getter
@Setter
public class AvaliacaoTRLPropriedadeIntelectual extends DefaultEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "id_avaliacao_trl_propriedade_intelectual")
    ...
    // Propriedade Intelectual relacionada - Deve ser só uma delas
    @ManyToOne
