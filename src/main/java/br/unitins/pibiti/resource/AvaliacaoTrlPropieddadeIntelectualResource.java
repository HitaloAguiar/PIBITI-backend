...
import br.unitins.pibiti.service.avaliacao_trl_pi.AvaliacaoTrlPropiedadeIntelectualService;
...
@Path("/propiedades-intelectuais/avaliacao-trl")
@Produces(MediaType.APPLICATION_JSON)
@Consumes(MediaType.APPLICATION_JSON)
public class AvaliacaoTrlPropieddadeIntelectualResource {

    @Inject
    AvaliacaoTrlPropiedadeIntelectualService avaliacaoTrlPropiedadeIntelectualService;
    ...
    public AvaliacaoTrlPiResponseDTO getAvaliacao(@PathParam("id") Long idAvaliacao) {
        return avaliacaoTrlPropiedadeIntelectualService.getAvaliacao(idAvaliacao);
    }
    ...
    public Response deletarAvaliacao(@PathParam("id") Long idAvaliacao) throws IllegalArgumentException, NotFoundException {
        ...
        try {
            avaliacaoTrlPropiedadeIntelectualService.deletarAvaliacao(cnpj, idAvaliacao);
