...
public interface IndicacaoGeograficaService {
    ...
    List<IndicacaoGeograficaResponseDTO> getAllByNit(Long idNit, int page, int pageSize, Boolean isAscending);

    List<IndicacaoGeograficaResponseDTO> getAllByNitFiltradoPorTitulo(Long idNit, String titulo, int page, int pageSize, Boolean isAscending);

    List<IndicacaoGeograficaResponseDTO> getAllPublico(int page, int pageSize, Boolean isAscending);

    List<IndicacaoGeograficaResponseDTO> getAllPublicoFiltradoPorTitulo(String titulo, int page, int pageSize, Boolean isAscending);
}
