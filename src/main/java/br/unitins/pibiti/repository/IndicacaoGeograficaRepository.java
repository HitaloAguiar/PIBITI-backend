...
public class IndicacaoGeograficaRepository implements PanacheRepository<IndicacaoGeografica> {
    ...
    public PanacheQuery<IndicacaoGeografica> findAllPublico(Sort sort) {

        return find("visualizacaoPublica = ?1", sort, true);
    }

    public PanacheQuery<IndicacaoGeografica> findAllPublicoFiltradoTitulo(Sort sort, String titulo) {
